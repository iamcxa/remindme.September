 ...
 */
public class ListCursorCardFragmentbackup extends BaseFragment implements
	...
	public static void setProjection(String[] projection) {
		ListCursorCardFragmentbackup.projection = projection;
	}
	...
	public static void setSortOrder(String sortOrders) {
		ListCursorCardFragmentbackup.sortOrder = sortOrders;
	}
	...
	public static void setSelection(String selections) {
		ListCursorCardFragmentbackup.selection = selections;
	}
}
